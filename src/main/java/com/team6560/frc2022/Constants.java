...
public final class Constants {
     ...
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.58;
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(73.652);

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 8;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 5;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 3;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(243.809);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(294.785);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(289.054);
