...
public final class Constants {
  ...
  // public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(260.771 + 180.0);

  // public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 8;
  // public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 5;
  // public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 3;
  // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(62.666 + 180.0);
  ...
  // public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(317.636 + 180.0);
  ...
  // public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(113.467 + 180.0);

  public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 22;
  public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 13;
  public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 2;
  public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(260.859);
  // public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(260.771);

  public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 8;
  public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 5;
  public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 3;
  public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(62.402);
  // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(62.666+45.0);

  public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 27;
  public static final int BACK_LEFT_MODULE_STEER_MOTOR = 6;
  public static final int BACK_LEFT_MODULE_STEER_ENCODER = 1;
  public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(315.791);
  // public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(317.636);

  public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 11;
  public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 14;
  public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 4;
  public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(111.094);
  // public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(113.467);
