...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    .add("has ball", this::hasObject);
      ...
      intakePoseMap.put(IntakePose.EXTENDED_CUBE, new IntakeState(0.92, 0.8, ArmPose.INTAKE_CUBE));
      intakePoseMap.put(IntakePose.EXTENDED_CONE, new IntakeState(1.0, -0.8, ArmPose.DEFAULT));
      intakePoseMap.put(IntakePose.RETRACTED, new IntakeState(-0.15, 0.0, ArmPose.NONE));
      intakePoseMap.put(IntakePose.HANDOFF_CONE, new IntakeState(0.45, -0.6, ArmPose.INTAKE_CONE));
      intakePoseMap.put(IntakePose.HANDOFF_CUBE, new IntakeState(0.88, -0.6, ArmPose.INTAKE_CUBE));
