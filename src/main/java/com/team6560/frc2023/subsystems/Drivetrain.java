...
public class Drivetrain extends SubsystemBase {
        ...
        public Drivetrain() {
                ...
                modules = new SwerveModule[] {m_frontLeftModule, m_frontRightModule, m_backLeftModule, m_backRightModule};
        }
        ...
        public void drive(ChassisSpeeds chassisSpeeds) {
                ...
                for (int i = 0; i < 4; i++) {
                        if (Math.abs(modules[i].getSteerAngle() - DEFAULT_MODULE_STATES[i].angle.getDegrees()) < 5.0 || modules[i].getDriveVelocity() != 0.0) {
